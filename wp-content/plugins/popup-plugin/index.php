...
* Plugin URI: http://nicolaipalmkvist.com/popup-plugin
...
function responsive_popup_form()
{
    ...
    $content .= '<div class="row">';
    $content .= '<img src=" '.plugins_url("popup-plugin/images/bgimage.jpg").' " alt="Zalando" id="backgroundimg" >';
    ...
    function register_styles_and_scripts_for_responsive_popup_form() 
    {
        ...
        wp_enqueue_style('CustomStylesheet', plugins_url('popup-plugin/css/style.css'));
        ...
        wp_enqueue_script('CustomScript', plugins_url('popup-plugin/js/script.js'), array('CustomMaterializeScript'), null, true);
    }
